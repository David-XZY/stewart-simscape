...
fprintf(fid, ['- Next optimization should be constrained, not score-only: add a ' ...
    'target-command prefilter/command governor with feedforward-consistent ' ...
    'derivatives, explicitly include DOB compensation in acceleration CBF ' ...
    'feasibility, and reduce QP execution cost before retuning tracking weights.\n']);
