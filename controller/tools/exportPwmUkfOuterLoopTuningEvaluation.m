...
if strlength(outputDir) == 0
    ...
    outputDir = fullfile(projectRoot, 'results', 'controller', ['pwm_ukf_outer_loop_tuning_', timestamp]);
end
if ~exist(outputDir, 'dir')
    mkdir(outputDir);
end

identifierFile = latestFile(fullfile(projectRoot, 'results', 'controller'), 'pwm_force_identifier_*.mat');
