function methodDoc = writeSafetyQpMethodDocument(projectRoot)
% writeSafetyQpMethodDocument - 写出 SC-QP 控制方法说明文档
docDir = fullfile(projectRoot, 'docs', 'controller_workflow');
if ~isfolder(docDir)
    mkdir(docDir);
end
methodDoc = fullfile(docDir, 'safety_qp_control_method.md');
text = [
